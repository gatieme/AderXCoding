			    ...
			    struct sym_compare_type *child_locals)
{
	...
	if (!table->local_syms)
		printf("find_local_syms for %s: found_none", hint);
}
...
int main(int argc, char **argv)
{
	...
	vmlinux = lookup_open(argv[1], argv[2], argv[3], &locals);
