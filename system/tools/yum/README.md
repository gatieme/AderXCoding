...
| CSDN | GitHub |
|:----:|:------:|
| [RHEL/CentOS/Fedora各种源(EPEL、Remi、RPMForge、RPMFusion)配置](http://blog.csdn.net/gatieme/article/details/61623891) | [`AderXCoding/system/tools/yum`](https://github.com/gatieme/AderXCoding/tree/master/system/tools/yum) |
